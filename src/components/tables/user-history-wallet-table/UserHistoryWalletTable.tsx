...
import { TransactionPaymentEntity, TransactionType } from '@/generated/graphql'
import { useCopy } from '@/hooks/useCopy'
import { PaginationState, SortingState } from '@tanstack/react-table'
import { Dispatch, FC, SetStateAction } from 'react'

import { prepareColumns } from './user-history-wallet-table-config'
...
const UserHistoryWalletTable: FC<Props> = ({
  data,
  canPrev,
  canNext,
  sorting,
...
export default UserHistoryWalletTable
